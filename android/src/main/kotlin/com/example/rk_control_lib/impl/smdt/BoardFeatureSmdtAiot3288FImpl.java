 ...
 * description :
 */
public class BoardFeatureSmdtAiot3288FImpl extends BoardFeatureManager {
    String TAG = TagConstant.TAG_BOARD_FEATURE + "-SmdtAiot3288F";
    private SmdtManager smdt;

    public BoardFeatureSmdtAiot3288FImpl(Context context, String boardType, BoardControlListener boardControlListener) {
        setMContext(context);
    ...
    public void closeScreen() {
        log(TAG,"息屏:"+smdt.smdtSetLcdBackLight(0));
    }

    @Override
    public void awakeDevice() {
        log(TAG,"亮屏:"+smdt.smdtSetLcdBackLight(1));
    }
...
//        smdt.setRelayIoValue(data);
    ...
    public Boolean isScreenBright() {
        boolean isLight = smdt.smdtGetLcdLightStatus() == 1;
        log(TAG,"屏幕是否开启:"+isLight);
        return isLight;
    }
    ...
    @Override
    public int readGpio(int id,int defaultReturnBValue) {
        return defaultReturnBValue;
    }
